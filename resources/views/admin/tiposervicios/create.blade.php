...
@section('body_class','admin_tiposervicios_create')
@section('main_class','admin_tiposervicios_create')
@section('content')

<div class="text-center page-header">
	<h1 class="text-center">Registro de Tipo de Servicios</h1>
</div>

<div class="panel panel-primary box_flot">
	<div class="panel-heading">
		<h3 class="panel-title">Registrar Tipo de Servicio</h3>
	</div>
	<div class="panel-body">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12">
				{!! Form::open(array('route' => 'admin.tiposervicios.store','method' => 'POST','class'=>'form-horizontal')) !!}
