...
<div class="panel panel-primary box_flo">
	...
	<div class="panel-body">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-offset-2 col-md-8">
				<ul class="list-group">
					...
					@endif
					<li class="list-group-item"><b>Cliente: </b><a href="{{ route('recepcionista.clientes.show',$evento->cotizacion->cliente->id) }}">{{ $evento->cotizacion->cliente->cedula }}</a></li>
		...
		<!--<div class="text-center">
			<a href="{{ route('recepcionista.eventos.pdf',$evento->id) }}" class="btn btn-primary">Ver Contrato</a>
		</div>-->
		@else
		<div class="jumbotron">
