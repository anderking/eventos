...
@section('title','Planificador-ListaEvento-Show')
@section('body_class','planificador_listaeventos_show')
@section('main_class','planificador_listaeventos_show')
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-offset-2 col-md-8">
				<ul class="list-group">
					...
					@endif
					<li class="list-group-item"><b>Cotizacion: </b>CZ0{{ $evento->cotizacion->id }}</li>
					<li class="list-group-item"><b>Cliente: </b>{{ $evento->cotizacion->cliente->cedula }}</li>
