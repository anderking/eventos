<div id="modal-delete-eventotareas-{{$eventotareas->id}}" class="modal fade" role="dialog">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      {!! Form::open(array('route' => ['planificador.eventotareas.destroy',$eventotareas->id],'method' => 'DELETE')) !!}
