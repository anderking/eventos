			...
			<div class="col-xs-12 col-sm-12 col-md-12">
				...
				<div class="form-group">
					...
					<div class="col-xs-12 col-sm-10 col-md-5">
						{!! Form::select('tipo', array(''=>'Seleccione una categoría','Planificación' => 'Planificación', 'Organización' => 'Organización','Ejecución'=>'Ejecución','Desmontaje'=>'Desmontaje','Cierre'=>'Cierre'), '', ['class'=>'form-control','required']) !!}
					</div>
				</div>
				<div class="form-group">
