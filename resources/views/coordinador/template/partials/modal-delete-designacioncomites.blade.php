<div id="modal-delete-designacioncomites-{{$designacioncomites->id}}" class="modal fade" role="dialog">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      {!! Form::open(array('route' => ['coordinador.designacioncomites.destroy',$designacioncomites->id],'method' => 'DELETE')) !!}
